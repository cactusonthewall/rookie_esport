...
$eventsResult = $event->getEventTeams($teamId, $offset, $limit);

$total_data = $event->countEventTeams($teamId);
?>
...
<head>
    ...
    <title>Team Events - <?= htmlspecialchars($teamName) ?></title>
...
<body>
    <div class="content-container">
        <div class="form-section">
            ...
            <h3>Events for Team <?= htmlspecialchars($teamName) ?></h3>
        </div>

        <div class="table-wrapper">
            <?php
            if ($eventsResult->num_rows == 0) {
                echo "<p style='text-align: center;'>No events available for this team.</p>";
            } else {
                echo "<table>
                    <tr>
                        <th>Event Title</th>
